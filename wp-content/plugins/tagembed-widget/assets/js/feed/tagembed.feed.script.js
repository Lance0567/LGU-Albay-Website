    ...
    __tagembed__feed_filters.addEventListener("change", function (event) {
        ...
        switch (__tagembed__feed_data.networkId) {
            case "1":
                ...
                break;
            case "2":
                __tagembed__createInstagramFeed(__tagembed__feed_data);
                break;
            case "3":
...
function __tagembed__createTwitterFeed(__tagembed__feed_data) {
    ...
    switch (__tagembed__feed_data.filterId) {
        ...
        case "2":
            ...
            break;
        case "3":
            __tagembed__feed_data.inputs = [{label: 'User Name', type: 'text', name: 'feed', placeholder: 'Enter User Name'}, {label: 'List Name', type: 'text', name: 'list', placeholder: 'Enter List Name'}].concat(__tagembed__common_inputs);
            break;
        case "4":
